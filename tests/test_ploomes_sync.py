...
from src.ploomes_sync import PloomesSync, ProcessingResult, SyncReport
...
class TestPloomesSync:
    ...
    def test_process_cnj_list(self, sync, mock_client):
        ...
        mock_client.search_deals_by_stage.return_value = [
            {
                "Id": 123,
                "OtherProperties": [{"FieldKey": "deal_20E8290A-809B-4CF1-9345-6B264AED7830", "StringValue": "11111111111111111"}]
            },
            {
                "Id": 456,
                "OtherProperties": [{"FieldKey": "deal_20E8290A-809B-4CF1-9345-6B264AED7830", "StringValue": "22222222222222222"}]
            }
        ]
